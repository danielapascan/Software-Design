...
/**
 * Custom AccessDeniedHandler implementation to handle access denied exceptions.
 */
@Slf4j
...
public class AccessDeniedHandlerBean implements AccessDeniedHandler {
    ...
    /**
     * Handles the access denied exception by setting the response status and writing the exception message as JSON.
     *
